    ...
    >
      <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
        ...
        <div className="flex items-center gap-5">
          {loading ? (
            <div className="animate-pulse h-full py-2">Loading...</div>
          ) : (
            <>
              {authUser ? (
                <>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-white text-primary-700 mt-6 mr-4">
                      <DropdownMenuItem
                ...
                <>
                  <Link href="/signin">
                    <Button className="text-white  border border-white bg-transparent hover:bg-white hover:text-primary-700 rounded-lg">
                      Sign In
                    </Button>
                  </Link>
                  <Link href="/signup">
